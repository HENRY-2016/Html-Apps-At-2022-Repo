...
<?php
    ...
    $events_post = "/kelly/back-end/controller.php/InsertIntoEventsEndpoint";
    $returns_post = "/kelly/back-end/controller.php/InsertIntoReturnsEndpoint";
    $borrows_post = "/kelly/back-end/controller.php/InsertIntoBorrowsEndpoint";
    $payments_post = "/kelly/back-end/controller.php/InsertIntoPaymentsEndpoint";
    $instruments_post = "/kelly/back-end/controller.php/InsertIntoInstrumentsEndpoint";



    $view_events = "/kelly/back-end/controller.php/GetEventsEndpoint";
    $view_returns = "/kelly/back-end/controller.php/GetReturnsEndpoint";
    $view_borrows = "/kelly/back-end/controller.php/GetBorrowsEndpoint";
    $view_payments = "/kelly/back-end/controller.php/GetPaymentsEndpoint";
    $view_instruments = "/kelly/back-end/controller.php/GetInstrumentsEndpoint";

    $staff_login= "/kelly/back-end/controller.php/SigInUserEndpoint";
    $admin_login= "/kelly/back-end/controller.php/SigInAdminEndpoint";


    // Admin
    $create_instrument = "/kelly/back-end/controller.php/AdminCreateInstrumentEndPoint";
    $create_admin =  "/kelly/back-end/controller.php/AdminCreateAdminEndPoint";
    $create_manager = "/kelly/back-end/controller.php/AdminCreateManagerEndPoint";

    $admin_view_staffs = "/kelly/back-end/controller.php/GetStaffsEndpoint";
    $admin_delete_user = "/kelly/back-end/controller.php/AdminDeleteUserEndPoint";
    $admin_delete_events = "/kelly/back-end/controller.php/AdminDeleteEventsEndPoint";
    $admin_delete_returns = "/kelly/back-end/controller.php/AdminDeleteReturnsEndPoint";
    $admin_delete_payments = "/kelly/back-end/controller.php/AdminDeletePaymentsEndPoint";
    $admin_delete_borrows = "/kelly/back-end/controller.php/AdminDeleteBorrowsEndPoint";
    $admin_delete_instruments = "/kelly/back-end/controller.php/AdminDeleteInstrumentsEndPoint";
